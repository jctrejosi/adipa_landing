...
return [
    ...
    [
        ...
        "options" => [
            ...
            ["label" => "Primeros auxilios psicológicos", "value" => "primeros-auxilios-psicologicos"],
            ["label" => "Psicología Clínica", "value" => "psicologia-clinica"],
            ["label" => "Psicología Educacional", "value" => "psicologia-educacional"],
            ["label" => "Psicología Jurídica", "value" => "psicologia-juridica"],
            ["label" => "Psicología Social Comunitaria", "value" => "psicologia-social-comunitaria"],
            ["label" => "Test Psicológicos", "value" => "test-psicologicos"],
        ],
    ],
    */
